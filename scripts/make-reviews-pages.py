...
reviews = [
    {
        ...
        "lang": "ar",
        "text": [
            "بصو يا جماعة أنا مش من الناس اللي بتحب تكتب ريفيوز كتير بس حبيت أقول تجربتي مع Power Shift كانت كويسة جدا كنت محتاج موقع للشركة ومكنتش عارف أبدأ منين واتناقشنا في التفاصيل لحد ما وصلنا للشكل المناسب",
        ],
    },
    {
        "id": "yassin",
